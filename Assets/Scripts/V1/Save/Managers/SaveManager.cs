...
public class SaveManager
{
    ...
    {
        return File.Exists(Path.Combine(ScoutingPresets, presetName));
    }
    ...
    public static void SaveMatchData(MatchData data)
    {
        ...
        string competitionPath = Path.Combine(SavedMatches, $"{data.Competition}_{data.deviceIdentifier}.csv");
